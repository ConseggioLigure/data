...
python ../tei2corpus.py literature.xml test_literature \
  -l lij ita eng \
  --only-ids ${TEST_IDS}

python ../tei2corpus.py literature.xml valid_literature \
  -l lij ita eng \
  --only-ids ${VALID_IDS}

python ../tei2corpus.py literature.xml train_literature \
  -l lij ita eng \
